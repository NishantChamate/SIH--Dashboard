!(function (e) {
            ...
            s(e, [
              ...
              },
              {
                ...
                value: function (t, i) {
                  ...
                  (e.currentId = r.getAttribute("id")),
                    a.default.setTitle(s.innerText),
                    this._ajaxify(r, i);
                },
              },
              {
        ...
        (a.prototype = {
          ...
          _indexOfListener: function (e, t) {
            for (var i, o = this._bindings.length; o--; )
              if ((i = this._bindings[o])._listener === e && i.context === t)
                return o;
            return -1;
          },
          has: function (e, t) {
  ...
  function (e, t, i) {
    ...
    function o(e, t, i, o) {
      return function (i) {
        (i.delegateTarget = (0, n.default)(i.target, t)),
  ...
  function (e, t) {
    ...
    (i.isTablet =
      ...
      (i.onTouchStart = function (e) {
        e.targetTouches
          ? ((i.mouseX = e.targetTouches[0].clientX),
            (i.mouseY = e.targetTouches[0].clientY))
          : e.changedTouches &&
            ((i.mouseX = e.changedTouches[0].clientX),
            (i.mouseY = e.changedTouches[0].clientY)),
          (i.dragX = 0),
          (i.dragY = 0),
      ...
      (i.updatePhysics = function () {
        (this.easedScrollSpeed += 0.1 * (i.scrollSpeed - i.easedScrollSpeed)),
          (this.absEasedScrollSpeed +=
            0.1 * (Math.abs(i.scrollSpeed) - i.absEasedScrollSpeed)),
    ...
    var a,
      ...
      b =
        (s(
          (a = (function (e) {
            function t(e, i) {
              ...
              return (
                t.header || (t.header = new d.default()),
                t.footer || (t.footer = new f.default()),
                o
              );
            }
            return (
              ...
              l(t, [
                {
                  ...
                  value: function () {
                    if (
                      ...
                      ((h.default.isSafari && this.previousPage) ||
                        (h.default.isIOS && this.previousPage)) &&
        ...
        s(
          ...
          "onWheel",
          [g.default],
          Object.getOwnPropertyDescriptor(a.prototype, "onWheel"),
          a.prototype
        ),
        s(
          a.prototype,
          ...
          s(t, [
            ...
            },
            {
              ...
              value: function () {
                ...
                e && d.default.deviceType,
                  (this.scrollable = new h.default(e, this));
              },
            },
            {
              key: "resize",
    ...
    var n,
      ...
      u =
        ((function (e, t, i, o, n) {
          ...
          "_hidden",
          [l.default],
          Object.getOwnPropertyDescriptor(n.prototype, "_hidden"),
          n.prototype
        ),
        n);
    t.default = u;
            ...
            l(t, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this._y < 0 || this.height <= u.default.height
                    ? (this._y = 0)
                    : this._y > e && (this._y = e);
                },
              },
              ...
              a(t, [
                ...
                },
                {
                  ...
                  value: function () {
                    if (!this.fixedScroll) {
                      ...
                      (this.height =
                        t < h.default.height ? h.default.height : t),
                        this.resetTimeline(),
                        this.isNative ||
                ...
                },
                {
                  ...
                  value: function () {
                    this.isNative ||
                      ((this.scrollRatio =
                        this.y / (this.height - h.default.height)),
                      this.scrollRatio < 0
                        ? (this.scrollRatio = 0)
        ...
        updateOnlyOwnProperties: function () {
          "undefined" != typeof window &&
            ...
            (l.deviceType = (function (e, t, i, o) {
              ...
              l.hasTouch,
              l.state.detectHover.anyHover,
              l.state.detectPointer.anyFine,
              l.state
            )),
        ...
        function e(t) {
          (function (e, t) {
            ...
            (this.switches = Array.from(
              n.default.currentPage.dom.querySelectorAll(this.selector)
            )),
    ...
    var n,
      ...
      l =
        ((function (e, t, i, o, n) {
                ...
                },
                {
                  ...
                  set: function (e) {
                    ...
                    this.debug &&
                      console.log(
                        t,
                        s.default.height + this.wrapper.offsetHeight
                      ),
          ...
          "init",
          [a.default],
          Object.getOwnPropertyDescriptor(n.prototype, "init"),
          n.prototype
        ),
        n);
    t.default = l;
              ...
              value: function () {
                if (!this.disabled) {
                  ...
                  e < n.default.height - 0.7 * this.wrapper.offsetHeight
                    ...
                    : e > n.default.height + this.margin &&
                      this.isShown &&
                      this.hide(),
              ...
              value: function () {
                var e = (this.delta * n.default.height) / 700,
                  ...
                  i =
                    ...
                    (this.scrollable.height - n.default.height),
                ...
                if (0 == o)
                  ...
                  if (
                    ((r = (n.default.height + this.wrapper.offsetHeight) * i),
                    o < n.default.height)
                  )
                    s.fromTo(
                      this.elt,
                    ...
                    this.forceEnd
                      ? (s.fromTo(
                        ...
                        this.scrollable._tl.add(
                          s,
                          this.scrollable._tl.duration() - r
                        ))
                      : (s.fromTo(
                          this.elt,
                          r,
                ...
                value: function () {
                  if (!c.default.isMobile) {
                    ...
                    new SplitText(o, { type: "lines" }).lines.forEach(function (
                      ...
                      Array.from(t.querySelectorAll(".coins")).forEach(
                        function (t, i) {
          ...
          n(e, [
            ...
            },
            {
              ...
              value: function (e) {
                var t = e.offsetTop;
                return (
                  e.parentElement != r.default.scrollable.dom &&
                    (t += this.getPageY(e.parentElement)),
                  t
                );
              },
            ...
            },
            {
              ...
              set: function (e) {
                if (((this._y = e), this.isVisible)) {
                  ...
                  var t =
                    e -
                    (r.default.scrollable.y - this.pageY + this.logo.offsetTop);
                  this.dom.parentElement._gsTransform &&
                    (t += this.dom.parentElement._gsTransform.y),
                    TweenLite.set(this.logoBall, { y: t }),
                    (t =
                      e -
                      (r.default.scrollable.y -
                        this.pageY +
                        this.menu.offsetTop +
            ...
            },
            {
              ...
              value: function (e) {
                if (
                  ...
                  var t = "youtube";
                else RegExp.$3.indexOf("vimeo") > -1 && (t = "vimeo");
  ...
  function (e, t, i) {
    ...
    !(function (r, s) {
      ...
      (o = function () {
        ...
        function t(e, t, r, a) {
          var l = ["then", "catch", "always"].reduce(function (e, t) {
              return (
                (e[t] = function (i) {
                  return (e[t] = i), e;
                }),
          ...
          return (
            u.open(e, c, !0),
            (u.withCredentials = a.hasOwnProperty("withCredentials")),
            o(u, a.headers, r),
            u.addEventListener("readystatechange", n(l, u), !1),
            u.send(s(r) ? JSON.stringify(r) : r),
            (l.abort = function () {
              return u.abort();
            }),
            l
        ...
        return function (i) {
          return (
            ...
            i.method && i.url
              ? t(i.method, i.baseUrl + i.url, e(i.data), i)
              : ["get", "post", "put", "delete"].reduce(function (o, n) {
                  return (
                    (o[n] = function (o, r) {
                      return t(n, i.baseUrl + o, e(r), i);
                    }),
                    o
                  );
                }, {})
        ...
        void 0 !== (n = o.call(t, i, t, e)) && (e.exports = n);
    })();
  },
]);
